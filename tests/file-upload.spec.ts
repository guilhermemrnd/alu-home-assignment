...
test.describe('File Upload and Initial Parsing', () => {
  ...
  test('should upload a CSV file and display headers and products', async ({ page }) => {
    await page.goto('/');
    ...
    // Check if headers are displayed (in mapping editor)   
